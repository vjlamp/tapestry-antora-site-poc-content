...
The javadoc:org.apache.tapestry5.annotations.Local[label=@Local] annotation is used to select the javadoc:org.apache.tapestry5.http.services.RequestHandler[] service defined by this module, `AppModule`.
