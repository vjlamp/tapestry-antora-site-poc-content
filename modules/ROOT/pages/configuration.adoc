...
tapestry.ajax-form-loop-add-row-link-css-class | javadoc:org.apache.tapestry5.SymbolConstants#AJAX_FORM_LOOP_ADD_ROW_LINK_CSS_CLASS[]::
Since 5.5.0 +
Defines the CSS class that will be given to the add row link generated by javadoc:org.apache.tapestry5.corelib.components.AjaxFormLoop[].
The default value is `btn btn-default btn-sm`.
...
tapestry.error-css-class | javadoc:org.apache.tapestry5.SymbolConstants#ERROR_CSS_CLASS[]:: 
Since 5.5.0 +
Defines the CSS class that will be given to the HTML element generated by javadoc:org.apache.tapestry5.corelib.components.Error[].
If the value isn't `help-block`, the class attribute will be `help-block [symbol value]`
The default value is `help-block`.

tapestry.errors-base-css-class | javadoc:org.apache.tapestry5.SymbolConstants#ERRORS_BASE_CSS_CLASS[]::
Since 5.5.0 +
Defines the prefix of the CSS class that will be given to the outer `<div>` element generated by javadoc:org.apache.tapestry5.corelib.components.Errors[].
The value of javadoc:org.apache.tapestry5.corelib.components.Errors[]'s `class` parameter appended after the prefix and a space character.
The default value is `alert-dismissable`.

tapestry.errors-close-button-css-class | javadoc:org.apache.tapestry5.SymbolConstants#ERRORS_CLOSE_BUTTON_CSS_CLASS[]:: 
Since 5.5.0 +
Defines the CSS class that will be given to the close <button> generated by javadoc:org.apache.tapestry5.corelib.components.Errors[].
The default value is `close`.

tapestry.errors-default-class-parameter-value | javadoc:org.apache.tapestry5.SymbolConstants#ERRORS_DEFAULT_CLASS_PARAMETER_VALUE[]:: 
Since 5.5.0 +
Defines the default value of the javadoc:org.apache.tapestry5.corelib.components.Errors[]'s `class` parameter.
The default value for this symbol is `alert alert-danger`.
...
See xref:cookbook:overriding-exception-reporting.adoc[] for details.
...
tapestry.openapi-application-version | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_APPLICATION_VERSION[]::
Since 5.8.0 +
Defines the version of this application in the generated OpenAPI description (i.e. info/version).
No default value is provided.

tapestry.openapi-base-path | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_BASE_PATH[]::
Since 5.8.0 +
Defines a base path to the generated OpenAPI description relative to the application URL as defined by javadoc:org.apache.tapestry5.http.services.BaseURLSource#getBaseURL(boolean)[].
It should be either the empty string, meaning there's no base path, or a string starting and ending with a slash.
Default value is `/`.

tapestry.openapi-description | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_DESCRIPTION[]::
Since 5.8.0 +
Defines the description of this application in the generated OpenAPI description.
No default value is provided.

tapestry.openapi-description-path | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_DESCRIPTION_PATH[]::
Since 5.8.0 +
...
Default value is `/openapi.json`.
The description will only be published if `tapestry.publish-openapi-description` is set to `true`.

tapestry.openapi-title | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_TITLE[]::
Since 5.8.0 +
Defines the title of this application in the generated OpenAPI description.
No default value is provided.

tapestry.openapi-version | javadoc:org.apache.tapestry5.SymbolConstants#OPENAPI_VERSION[]::
Since 5.8.0 +
...
tapestry.publish-openapi-description | javadoc:org.apache.tapestry5.SymbolConstants#PUBLISH_OPENAPI_DEFINITON[]::
Since 5.8.0 +
...
Since 5.4.0 +
A flag (`true` or `false`) that, if `true`, changes some default Tapestry behavior to make it work better in restrictive environments such as xref:cookbook:google-app-engine.adoc[Google App Engine (GAE)].
