...
Yet another option is available: instead of binding an interface to a implemention class, you can bind a service to a xref:org.apache.tapestry5.ioc.ServiceBuilder[], a callback used to create the service implementation.
