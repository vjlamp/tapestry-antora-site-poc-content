...
== Builtin Services
A few services within the Tapestry IOC Module are "builtin"; there is no service builder method in the javadoc:org.apache.tapestry5.ioc.modules.TapestryIOCModule[] class.
