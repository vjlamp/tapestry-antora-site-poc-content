...
Often, all services in a module should share a marker, this can be specified with a javadoc:org.apache.tapestry5.annotations.Marker[label=@Marker] annotation on the module class.
